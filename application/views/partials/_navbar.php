          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <div class="nav-link mt-2 mt-md-0 d-none d-lg-flex search justify-content-center">
                  Welcome To kafe Laine Dashboard
                </div>
              </li>
            </ul>
...
<!--                   <div class="dropdown-divider"></div>
                  ...
                  <div class="dropdown-divider"></div>
                  <a href="<?= base_url('Admin/Process_User/Proses_Logout_User') ?>" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
